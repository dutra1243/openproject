  ...
  describe "hardcoded Backlogs item component" do
    ...
    it "renders items through Backlogs::WorkPackageCardListItemComponent" do
      ...
      expect(rendered_component).to have_css(
        ".Box-row#work_package_#{work_package.id} .op-backlogs-story[data-controller='backlogs--story backlogs--item']"
      )
    end

    it "renders Backlogs-specific card data attributes" do
      work_package = work_packages.first
